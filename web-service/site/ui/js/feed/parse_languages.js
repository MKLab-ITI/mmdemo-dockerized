$.ajax({
    type: "GET",
    url: api_folder+"top/language?collection=" + collection_param + "&source=Facebook,Twitter,Flickr,Youtube,Instagram,Web,GooglePlus&since="+language_since+"&until="+language_until,
    dataType: "json",
