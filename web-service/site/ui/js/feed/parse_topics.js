$.ajax({
    type: "GET",
    url: api_folder+"topics?collection=" + collection_param + "&source=Facebook,Twitter,Flickr,Youtube,Instagram,Web,GooglePlus&since="+language_since+"&until="+language_until,
    dataType: "json",
