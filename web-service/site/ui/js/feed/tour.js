...
switch (translation_param) {
    case "en":
        titles_1 = ["Settings", "Search", "Social Networks", "Language", "Topics","Concepts", "Original", "Type", "Unique", "Date", "Sort", "Feed", "Dashboard", "Social Item"];
        contents_1 = ["Click to toggle settings tab.", "Search for content with a specific keyword / hashtag.", "Filter content based on source(s).", "Filter content based on language.", "Define certain topics.","Filter content based on concept", "Define source of item.", "Define type of items.", "Define if items are unique", "Define time window.", "Define sort criteria.", "Inspect social feed.", "Track a various collection of analytics.", "This is a individual social item with all the contained information."];
        titles_2 = ["Settings", "Search", "Social Networks", "Language", "Topics","Concepts", "Original", "Type", "Unique", "Date", "Feed", "Dashboard", "Posts", "Users", "Reach", "Endorsements", "Timeline", "Social Mix", "Heatmap", "Users Locations", "Active Users", "Entities"];
        contents_2 = ["Click to toggle settings tab.", "Search for content with a specific keyword / hashtag.", "Filter content based on source(s).", "Filter content based on language.", "Define certain topics.","Filter content based on concept", "Define source of item.", "Define type of items.", "Define if items are unique", "Define time window.", "Inspect social feed.", "Track a various collection of analytics.", "The number of posts made.", "The number of users made one or more posts.", "The number of users read one or more posts.", "The number of likes", "The number of posts in time.", "Source Analysis of posts, users, reach, endorsement.", "Location Analysis of posts.", "Location Analysis of users.", "Top influencers", "Top entities."];
        nextBtn = "Next", prevBtn = "Back", doneBtn = "Done", skipBtn = "Skip", closeTooltip = "Close";
        break;
    case "el":
        titles_1 = ["Ρυθμίσεις", "Αναζήτηση", "Κοινωνικά Δίκτυα", "Γλώσσα", "Θέματα","Ενότητες", "Πηγή", "Τύπος", "Μοναδικά", "Ημερομηνία", "Ταξινόμηση", "Ροή", "Πίνακας", "Δημοσίευση"];
        contents_1 = ["Εμφάνισε / Κρύψε το μενού.", "Αναζήτηση με συγκεκριμένη ετικέτα.", "Φιλτράρισε το περιοχόμενο αναλόγως το Κοινωνικό Δίκτυο.", "Φιλτράρισε το περιοχόμενο αναλόγως τη γλώσσα.", "Καθόρισε ένα θέμα.", "Φιλτράρισε το περιοχόμενο αναλόγως την ενότητα.", "Καθόρισε την πηγή.", "Καθόρισε τον τύπο.", "Καθόρισε αν οι δημοσιεύσεις είναι μοναδικές", "Καθόρισε το χρονικό παράθυρο.", "Καθόρισε το κριτήριο ταξινόμησης.", "Επίβλεψε την ροή των δημοσιεύσευων.", "Δες μια σειρά από στατιστικά.", "Αυτή είναι μια δημοσίευση με όλη την πληροφορία."];
        titles_2 = ["Ρυθμίσεις", "Αναζήτηση", "Κοινωνικά Δίκτυα", "Γλώσσα", "Θέματα","Ενότητες", "Πηγή", "Τύπος", "Μοναδικά", "Ημερομηνία", "Ροή", "Πίνακας", "Δημοσιεύσεις", "Χρήστες", "Θέαση", "Φιλοφρονήσεις", "Χρονοδιάγραμμα", "Κοινωνικά Δίκτυα", "Χάρτης Σημείων", "Τοποθεσία Χρηστών", "Ενεργοί Χρήστες", "Οντότητες"];
        ...
        break;
    case "it":
        titles_1 = ["Impostazioni", "Cerca", "Social Networks", "Lingua", "Temi","Concepts", "Originale", "Tipo", "Unique", "Data", "Ordina", "Feed", "Bacheca", "Contenuto sociale/argomento"];
        contents_1 = ["Clicca per passare al/attivare il pannello impostazioni.", "Cerca per una specifica parola chiave o hashtag.", "Filtra il contenuto in base alla fonte.", "Filtra il contenuto in base alla lingua.", "Definisci un tema.","Filter content based on concept", "Definisci la fonte dell'argomento.", "Definisci l'oggetto.", "Define if items are unique", "Definisci I criteri di ordinamento.", "Definisci I criteri di ordinamento.", "Monitora social feed.", "Vedi le statistiche.", "Questo è un contenuto individuale con relative informazioni ."];
        titles_2 = ["Impostazioni", "Cerca", "Social Networks", "Lingua", "Temi","Concepts", "Originale", "Tipo", "Unique", "Data", "Feed", "Bacheca", "Posts", "Utenti", "Consultati", "Approvati", "Orario", "Reti sociali", "Mappa di calore web", "Posizione dell'utente", "Utenti attivi", "Entità"];
        contents_2 = ["Clicca per passare al/attivare il pannello impostazioni.", "Cerca per una specifica parola chiave o hashtag.", "Filtra il contenuto in base alla fonte.", "Filtra il contenuto in base alla lingua.", "Definisci un tema.","Filter content based on concept", "Definisci la fonte dell'argomento.", "Definisci l'oggetto.", "Define if items are unique", "Definisci I criteri di ordinamento.", "Monitora social feed.", "Vedi le statistiche.", "Numero di post.", "Numero di utenti autori di uno o più post.", "Numero di utenti lettori di uno o più post.", "Numero di approvazioni.", "Numero di post in un determinato tempo.", "Analisi di post, utenti, consultati, approvati.", "Analisi della posizione dei post.", "Analisi della posizione degli utenti.", "Top influencers.", " Top entità."];
        nextBtn = "Successivo", prevBtn = "Indietro", doneBtn = "Fine", skipBtn = "Ignora", closeTooltip = "Chiudi";
        break;
    case "tr":
        titles_1 = ["Ayarlar", "Ara", "Sosyal Ağlar", "Dil", "Konular","Concepts", "Orijinal", "Tur", "Unique", "Tarih", "Sirala", "Feed", "Panel", "Orijinal"];
        contents_1 = ["Ayarlar sekmesine geçmek için tıkla.", "Belirli bir anahtar kelime veya hashtag ile ilgili içerik ara.", "İçeriği kaynaklara göre filtrele.", "İçeriği dile göre filtrele.", "Belirli konular tanımla.","Filter content based on concept", "Öğenin kaynağını tanımla.", "Öğe türünü tanımla.", "Define if items are unique", "Zaman penceresi tanımla.", "Sıralama kriterini belirle.", "Sosyal girdileri denetle.", "İstatistikleri takip et.", "Bu bireysel sosyal öğe tüm bilgileri içerir."];
        titles_2 = ["Ayarlar", "Ara", "Sosyal Ağlar", "Dil", "Konular","Concepts", "Orijinal", "Tur", "Unique", "Tarih", "Feed", "Panel", "Gönderiler", "Kullanıcılar", "Ulaşılan", "Onaylananlar", "Zaman tüneli", "Sosyal Karışım", "Isı haritası", "Konum", "Aktif kullanıcılar", "Girişler"];
        contents_2 = ["Ayarlar sekmesine geçmek için tıkla.", "Belirli bir anahtar kelime veya hashtag ile ilgili içerik ara.", "İçeriği kaynaklara göre filtrele.", "İçeriği dile göre filtrele.", "Belirli konular tanımla.","Filter content based on concept", "Öğenin kaynağını tanımla.", "Öğe türünü tanımla.", "Define if items are unique", "Zaman penceresi tanımla.", "Sosyal girdileri denetle.", "İstatistikleri takip et.", "Gönderilerin sayısı.", "Gönderi yapan kullanıcı sayısı.", "Gönderi okuyan kullanıcı sayısı.", "Beğenilerin sayısı.", "Belirli bir zaman aralığında yapılan gönderilerin sayısı.", "Gönderi, kullanıcı, erişim ve onayların Kaynak Analizi.", "Gönderilerin konum analizi.", "Kullanıcıların konum analizi.", "En etkileyiciler.", "En iyi girdiler."];
        nextBtn = "İleri", prevBtn = "Geri", doneBtn = "Tamamlandı", skipBtn = "Atla", closeTooltip = "Kapat";
        break;
    case "es":
        titles_1 = ["Ajustes", "Buscar", "Redes sociales", "Idioma", "Temas","Concepts", "Original", "Tipo", "Unique", "Fecha", "Ordenar", "Alimentar", "Tablero", "Publicación"];
        contents_1 = ["Haga clic para activar la pestaña de configuración.", "Buscar contenido con una palabra clave / hashtag específico", "Filtrar contenido basado en la fuente (s).", "Filtrar contenido basado en el lenguaje.", "Filtrar contenido basado en el lenguaje","Filter content based on concept", "Ajuste la fuente.", "Definir tipo de artículos.", "Define if items are unique", "Establecer la ventana de tiempo.", "Definir los criterios de clasificación.", "Inspeccionar Social de alimentación.", "Ver una serie de estadísticas.", "Se trata de una publicación con toda la información."];
        titles_2 = ["Ajustes", "Buscar", "Redes sociales", "Idiom", "Temas","Concepts", "Original", "Tipo", "Unique", "Fecha", "Alimentar", "Tablero", "Mensajes", "Usuarioas", "Sobrepasado", "Atenciones", "Calendario", "Mezcla Social", "Mapa de puntos", "Ubicación del usuario", "Los usuarios activos", "Entidades"];
        contents_2 = ["Haga clic para activar la pestaña de configuración.", "Buscar contenido con una palabra clave / hashtag específico", "Filtrar contenido basado en la fuente (s).", "Filtrar contenido basado en el lenguaje.", "Filtrar contenido basado en el lenguaje","Filter content based on concept", "Ajuste la fuente.", "Definir tipo de artículos.", "Define if items are unique", "Establecer la ventana de tiempo.", "Inspeccionar Social de alimentación.", "Ver una serie de estadísticas.", "El número de publicaciones.", "El número de usuarios que publicó uno o más mensajes.", "El número de usuarios que leen una publicación.", "El número de 'me gusta'", "El número de publicaciones por tiempo.", "Análisis fuente de los mensajes, los usuarios, alcance, atenciones.", "Análisis del lugar de las publicaciones.", "Análisis ubicación de los usuarios.", "Lo más influyentes.", "Top entidades."];
        nextBtn = "Siguiente", prevBtn = "Volver", doneBtn = "Hecho", skipBtn = "Omitir", closeTooltip = "Cerrar";
        break;
    case "ca":
        titles_1 = ["Configuració", "Cerca", "Xarxes Socials ", "Idioma", "Temes","Concepts", "Original", "Tipus", "Unique", "Data", "Ordena", "Introdueix dades", "Escriptori", "Element social "];
        contents_1 = ["Feu clic per activar la pestanya de configuració.", "Cerca contingut per mitjà d'una paraula clau o hashtag.", "Flitra el contingut en funció de la font.", "Filtra el contingut en funció de l'idioma.", "Defineix certs temes", "Defineix la font de l'article.","Filter content based on concept", "Defineix tipus d'articles.", "Define if items are unique", "Defineix la finestra temporal.", "Defineix els criteris d'ordenació.", "Inspecciona les xarxes socials.", "Realitza el seguiment d'un recull variat de dades analítiques.", "Aquest és un element social individual amb tota la informació vinculada."];
        titles_2 = ["Configuració", "Cerca", "Xarxes Socials", "Idioma", "Temes","Concepts", "Original", "Tipus", "Unique", "Data", "Feed", "Escriptori", "Publicacions", "Usuaris", "Involucrats", "Adhesions", "Termini", "Xarxes socials", "Mapa web", "Localització dels usuaris", "Usuaris actius", "Entitats"];
...
var tour = {
    ...
    steps: [
        ...
        },
        {
            ...
            ,
            onNext: function () {
                $('#slider').animate({scrollTop: $("#hop13").offset().top}, 0);
            }
        },
        {
            title: titles_1[5],
