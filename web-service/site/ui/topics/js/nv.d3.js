    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            distWrap
                ...
                .attr('data-color', function(d,i) {return d.color });
...
nv.models.scatter = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            function updateInteractiveLayer() {
                ...
                if (useVoronoi === true) {
                    ...
                    var vPointPaths = pointPaths
                        ...
                        .attr('data-color', function(d,i) { return d.data.point[4].color })
            ...
            points.enter().append("text").text(function(d){return d[0].topic_num;}).attr('transform', function(d) {
                return 'translate(' + (x(getX(d[0],d[1]))+15) + ',' + y(getY(d[0],d[1])) + ')'
            })
