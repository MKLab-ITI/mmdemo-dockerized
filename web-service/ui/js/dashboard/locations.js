...
function draw_locations() {
    ...
    $.ajax({
        type: "GET",
        url: api_folder+"top/country?collection=" + collection_param + "&q=" + query_param + "&language=" + language_param + "&original=" + original_param + "&type=" + type_param + "&source=" + source_param + "&topicQuery=" + topic_param+ "&since=" + since_param + "&until=" + until_param,
        dataType: "json",
...
function draw_gages(direction) {
    ...
    if (direction === 'right') {
        ...
        $.ajax({
            type: "GET",
            url: api_folder+"top/country?collection=" + collection_param + "&q=" + query_param + "&language=" + language_param + "&original=" + original_param + "&type=" + type_param + "&source=" + source + "&topicQuery=" + topic_param+ "&since=" + since_param + "&until=" + until_param,
            dataType: "json",
            success: function (json) {
                var $values = json.values;
                $values.shift();
