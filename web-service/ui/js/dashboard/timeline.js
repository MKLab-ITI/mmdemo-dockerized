...
function draw_timeline() {
    ...
    $.ajax({
        type: "GET",
        url: api_folder+"timeline?resolution=" + resolution + "&language=" + language_param + "&collection=" + collection_param + "&q=" + query_param + "&since=" + date + "&original=" + original_param + "&type=" + type_param + "&source=" + source_param + "&topicQuery=" + topic_param + "&since=" + since_param + "&until=" + until_param,
        dataType: "json",
